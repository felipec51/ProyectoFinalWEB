...
<body>
	...
	<div class="desktop">
		<img src="./imgs/fondoini.jpg" class="co-es-20251027-trifecta-perspe-icon" alt="">

		<div class="iniciar-sesion-pc">
			<div class="iniciar-sesion-pc-child">
			</div>
			...
			<div class="login-with-wrapper">
				<div class="login-with">
					...
					<div class="login-with-child">
					</div>
					<div class="login-with-item">
					</div>
				</div>
			</div>
			<div class="facebook-ic-parent">
				<img src="./imgs/icons/facebook.svg" class="facebook-ic-icon" alt="">

				<img src="./imgs/icons/google.svg" class="facebook-ic-icon" alt="">
