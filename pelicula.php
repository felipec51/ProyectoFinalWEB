...
include 'componentes/episodios.php';
...
$url_trailer1 = $pelicula_actual['trailer1'];
$url_trailer2 = $pelicula_actual['trailer2'];
$episodios = $pelicula_actual['episodios'];
$ncopia = $pelicula_actual['ncopias'];
$ncopiastotales = $pelicula_actual['ncopiastotales'];
$nfila = $pelicula_actual['nfila' ];
?>
...
<body>
	<div class="desktop">
		...
		if ($ncopia) {
			...
			rendernodisponible(	$nombre_serie,$ncopia,$ncopiastotales,$nfila,$duracion_tag,$anio);
		}
		?>
		<div class="rewindcodefilm">RewindCodeFilm</div>
		<?php rendertags($nombre_serie, $anio, $duracion_tag, $clasificacion, $descripcion, $elenco_resumen, $creadores); ?>
		<?php renderTrailers($nombre_serie, $url_trailer1, $url_trailer2); ?>
		<?php renderepisodios($nombre_serie, $episodios); ?>
