                    ...
                    <div class="app2">
                        <header class="app3">
                            ...
                            <div class="container">
                                ...
                                <div class="container2">
                                    <div class="input">
                                        <div class="buscar-pelculas-directores">Buscar películas, directores...</div>
                                    </div>
                                    <img class="icon2" alt="">
                                </div>
                            </div>
                            <div class="container3">
                                ...
                                <div class="button">
                                    <img class="icon3" alt="">
                                    <div class="agregar-pelcula">Agregar Película</div>
                                </div>
                            </div>
                            <div class="sidebartrigger">
                                <div class="toggle-sidebar">Toggle Sidebar</div>
                            </div>
                        </header>
                            ...
                            <div class="card">
                                <div class="statscard">
                                    <div class="container5">
                                        <div class="paragraph">
                                            <div class="total-pelculas">Total Películas</div>
                                        </div>
                                        <div class="heading-3">8</div>
                            ...
                            <div class="card2">
                                <div class="statscard2">
                                    <div class="container7">
                                        <div class="paragraph">
                                            <div class="total-pelculas">Rating Promedio</div>
                                        </div>
                                        <div class="heading-32">8.3</div>
                                ...
                                <div class="statscard3">
                                    <div class="container9">
                                        <div class="paragraph5">
                                            <div class="total-pelculas">Géneros</div>
                                        </div>
                                        <div class="heading-33">7</div>
                                    </div>
                            ...
                            <div class="card4">
                                <div class="statscard4">
                                    <div class="container10">
                                        <div class="paragraph">
                                            <div class="total-pelculas">Visualizaciones</div>
                                        </div>
                                        <div class="heading-32">156K</div>
                                        <div class="paragraph4">
                        ...
                        <div class="container12">
                            <div class="container13">
                                <div class="heading-2">Catálogo de Películas</div>
                            ...
                            <div class="container14">
                                ...
                                <div class="netflixmoviecard">
                                    <img class="image-inception-icon" alt="">
                                    <div class="container15">
                                        <div class="heading-35">Inception</div>
                                ...
                                <div class="netflixmoviecard2">
                                    <img class="image-inception-icon" alt="">
                                    <div class="container19">
                                        <div class="heading-36">El Caballero Oscuro</div>
                                ...
                                <div class="netflixmoviecard3">
                                    <img class="image-inception-icon" alt="">
                                    <div class="container19">
                                        <div class="heading-36">Interestelar</div>
                                        <div class="paragraph10">
                                            <div class="en-el-catlogo">Christopher Nolan</div>
                                        </div>
                                        <div class="container20">
                                ...
                                <div class="netflixmoviecard6">
                                    <img class="image-inception-icon" alt="">
                                    <div class="container35">
                                        <div class="heading-310">
                ...
                <div class="container43">
                    <div class="sidebarheader">
                        <div class="appsidebar">
                            <div class="container44">R</div>
                            <div class="container45">
                                <div class="text23">RewindCodeFilm</div>
                                <div class="text24">Admin Panel</div>
                            </div>
                        </div>
                    </div>
                    <div class="sidebarcontent">
                        <div class="sidebargroup">
                            <div class="sidebargrouplabel">Navegación</div>
                            <div class="sidebarmenu">
                                <div class="sidebarmenuitem">
                                    <div class="slotclone">
                                        <img class="icon18" alt="">
                                        <div class="appsidebar2">Inicio</div>
                                    </div>
                                </div>
                                <div class="sidebarmenuitem2">
                                    <div class="slotclone2">
                                        <img class="icon18" alt="">
                        ...
                        <div class="sidebargroup2">
                            <div class="sidebargrouplabel2">Gestión</div>
                        ...
                        <div class="sidebarmenu3">
                            ...
                            <div class="sidebarmenuitem9">
                                <div class="slotclone9">
                                    <div class="primitivespan2">AD</div>
                                    <div class="appsidebar10">
                                        <div class="text25">Admin</div>
                                        <div class="text26">admin@rewindcodefilm.com</div>
                                    </div>
                                </div>
                            </div>
                        </div>
